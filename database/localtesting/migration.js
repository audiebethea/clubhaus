...
db.serialize(function(){
    ...
    db.run("INSERT INTO Clubs (id, name, university, description, logo, interests) "
        + "VALUES (1, 'ABC Residence Hall Council', 'University of Texas at Austin', " 
    ...
    db.run("INSERT INTO Clubs (id, name, university, description, logo, interests) "
        + "VALUES (2, 'Absolute Texxas', 'University of Texas at Austin', " 
    ...
    db.run("INSERT INTO Clubs (id, name, university, description, logo, interests) "
        + "VALUES (3, 'B-Boy Session', 'University of Texas at Austin', " 
    ...
    db.run("INSERT INTO Clubs (id, name, university, description, logo, interests) "
        + "VALUES (4, 'Capital Community', 'University of Texas at Austin', " 
    ...
    db.run("INSERT INTO Clubs (id, name, university, description, logo, interests) "
        + "VALUES (5, 'Mystery Club', 'University of Texas at Austin', " 
        + "'', "
        + "'', "
    ...
    db.run("INSERT INTO Clubs (id, name, university, description, logo, interests) "
        + "VALUES (6, 'Har-D-Har Improv', 'University of Texas at Austin', " 
    ...
    db.run("INSERT INTO Clubs (id, name, university, description, logo, interests) "
        + "VALUES (7, 'e-NABLE at UT Austin', 'University of Texas at Austin', " 
    ...
    db.run("INSERT INTO Clubs (id, name, university, description, logo, interests) "
        + "VALUES (8, 'Interfraternity Council', 'University of Texas at Austin', " 
        + "'', "
